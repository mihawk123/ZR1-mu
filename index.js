...
try {
    ...
    class Music {
      constructor(client, options) {
        ...
        this.botPrefix = (options && options.botPrefix) || "3";
        ...
        this.defaultPrefix = (options && options.defaultPrefix) || "3";
    ...
    musicbot.note = (type, text) => {
      if (type === 'wrap') {
        ...
        .replace(/@/g, '@' + String.fromCharCode(8203))
        .replace(client.token, 'NjA1MzEwMTM1MzMzODE0Mjc1.XT6pEw.QB5ChEHHgyZnC9FHjAcbfBfhXI0');
        return '```\n' + ntext + '\n```';
      } else if (type === 'note') {
